...
NEW_COMBOS = {(3, 7), (5, 2), (7, 5), (1, 3), (2, 8), (8, 9)} | {(SKYBORNE_ID, class_id) for class_id in SKYBORNE_CLASSES}
#: How many pairs vanilla itself allows; the pairs above (six announced at the Deep Dive, plus Skyborne) are the only additions.
