...
// pre-effect SSR output ("Loading.", same as Guild.test.ts) plus the absence of the other
// three views' testids, rather than a testid Guild.svelte cannot produce in this render path.
describe('GuildShell', () => {
