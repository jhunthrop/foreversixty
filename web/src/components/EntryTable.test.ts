...
const rows = [
  { href: '/dungeons/hall-of-thanes', title: 'Hall of Thanes', meta: 'Dun Morogh', levelMin: 24, levelMax: 32 },
  { href: '/dungeons/alcaz-prison', title: 'Alcaz Prison', meta: 'Dustwallow Marsh', levelMin: 56, levelMax: 60 },
...
describe('EntryTable', () => {
  it('renders the headings, one linked row per entry, and rarity-coloured ranges', async () => {
    ...
    const html = await c.renderToString(EntryTable, { props: { nameHeading: 'Dungeon', metaHeading: 'Zone', rows } });
