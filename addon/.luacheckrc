...
read_globals = {
	...
	"RAID_CLASS_COLORS", "InCombatLockdown", "IsControlKeyDown", "UIFrameFadeIn", "SOUNDKIT", "PlaySound", "UnitRace", "GetAddOnMetadata", "C_AddOns", "EquipItemByName", "C_Item", "C_Timer",
