...
read_globals = {
	...
	"RAID_CLASS_COLORS", "InCombatLockdown", "IsControlKeyDown", "ForeverSixtyData", "GetCurrentRegion", "UnitIsPlayer", "C_Spell", "GetSpellTexture", "UIFrameFadeIn", "SOUNDKIT", "PlaySound", "UnitRace", "GetAddOnMetadata", "C_AddOns", "EquipItemByName", "C_Item", "C_Timer",
...
files["tests/"] = {
	...
	globals = {
		...
		"RAID_CLASS_COLORS", "InCombatLockdown", "IsControlKeyDown", "ForeverSixtyData", "GetCurrentRegion", "C_Spell", "GetSpellTexture", "UIFrameFadeIn", "SOUNDKIT", "PlaySound", "UnitRace", "GetAddOnMetadata", "C_AddOns", "EquipItemByName", "C_Item", "C_Timer",
		"ITEM_QUALITY_COLORS",
